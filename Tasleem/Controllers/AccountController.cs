    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeliveryRegister(RegisterDTO registerDTO)
        {
            if (ModelState.IsValid) 
            {
				...
				ApplicationUser existingUserByEmail = await _userManager.FindByEmailAsync(registerDTO.Email);
        ...
        [HttpGet("AllSubAdmin")]
        public IActionResult AllSubAdmin()
        {

           List <RegisterDTO> dTO = _accountService.AllSubAdmin();
        ...
        [HttpGet("GetSubAdminById")]
        public IActionResult GetSubAdminById(string id)
        {
            if (ModelState.IsValid)
            {
                RegisterDTO registerDTO = _accountService.GetsubAdminByID(id);
                if (registerDTO != null)
                {
                    ResultDTO resultDTO = new ResultDTO();
...
/*
        [HttpPut("EditSubAdminById")]
        public IActionResult EditSubAdminById([FromForm] EditSubAdminDataDTO dto, [FromForm] params string[] properties)

        {
            ...
            if (ModelState.IsValid)
            {
                ClientProfileDTO ClientProfileDTO = _accountService.EditSubAdminById(dto, properties);
                _unitOfWork.CommitChanges();
